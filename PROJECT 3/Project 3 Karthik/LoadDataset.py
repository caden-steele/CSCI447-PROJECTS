...
class LoadDataset:
        def __init__(self):
                ...
                self.datafiles = ['abalone.data',
                                 'forestfires.data', 'glass.data', 'cancer-wisconsin.data','soybean-small.data', 'machine.data']
        ...
        def IsClassificationDict(self):
                ...
                return {'abalone': True, 'glass': True, 'soybean-small': True, 'machine': False,
        ...
        def get1sthiddenlayernode(self, key):
                ...
                dict_list = {'abalone': 100, 'glass': 30, 'machine': 30,
                        'forestfires': 30, 'cancer-wisconsin': 60, 'soybean-small': 40}
        ...
        def get2ndhiddenlayernode(self, key):
                ...
                dict_list = {'abalone': [40,40], 'glass': [15,15], 'cancer-wisconsin': [10, 10], 'machine': [15,15] ,
                        'forestfires': [15,15], 'soybean-small': [15,15]}
                return dict_list.get(key)
#ld = LoadDataset()
